...
class ImportPriceFile(models.TransientModel):
    ...
    def _import_csv(self, load_id, file_data, delimeter=';'):
        ...
        # keys2 = reader_info[0]
        counter = 0
        keys = ['sku', 'description', 'vendor_sku', 'price', 'discount_1', 'discount_2',
                'retail', 'pdv1', 'pdv2']
        ...
        for i in range(len(reader_info)):
		 ...
		 'vendor_sku': values['vendor_sku'],
                 ...
                 'price_2': float(values['price_2'].replace(',', '.')),
                 'price_3': float(values['price_3'].replace(',', '.')),
                 'qty_2': float(values['pdv2'].replace(',', '.')),
                 'qty_3': float(values['pdv3'].replace(',', '.')),
    ...
    def _import_xls(self, load_id, file_data):
        ...
        values = {}
        keys = ['sku', 'description', 'vendor_sku', 'price', 'discount_1',
